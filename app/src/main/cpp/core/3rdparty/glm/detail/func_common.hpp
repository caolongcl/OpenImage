...
template<typename T, precision P, template<typename, precision> class vecType>
GLM_FUNC_DECL vecType<T, P> clamp(vecType<T, P> const &x,
...
GLM_FUNC_DECL vecType<T, P> mix(vecType<T, P> const &x,
                                vecType<T, P> const &y,
                                vecType<U, P> const &a);
...
template<typename T, precision P, template<typename, precision> class vecType>
GLM_FUNC_DECL vecType<T, P> smoothstep(vecType<T, P> const &edge0,
