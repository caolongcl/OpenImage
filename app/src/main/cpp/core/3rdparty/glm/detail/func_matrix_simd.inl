...
struct compute_matrixCompMult<tmat4x4, float, P, true> {
  ...
  GLM_FUNC_QUALIFIER static tmat4x4<float, P> call(tmat4x4<float, P> const &x,
                                                   tmat4x4<float, P> const &y) {
...
struct compute_inverse<tmat4x4, float, P, true> {
  GLM_FUNC_QUALIFIER static tmat4x4<float, P> call(tmat4x4<float, P> const &m) {
    tmat4x4<float, P> Result(uninitialize);
    glm_mat4_inverse(*reinterpret_cast<__m128 const (*)[4]>(&m[0].data),
...
template<>
GLM_FUNC_QUALIFIER tmat4x4<float, aligned_lowp>
  outerProduct<float, aligned_lowp, tvec4, tvec4>(tvec4 < float, aligned_lowp >
const & c,
...
template<>
GLM_FUNC_QUALIFIER tmat4x4<float, aligned_mediump>
  outerProduct<float, aligned_mediump, tvec4, tvec4>(tvec4 < float, aligned_mediump >
const & c,
...
template<>
GLM_FUNC_QUALIFIER tmat4x4<float, aligned_highp>
  outerProduct<float, aligned_highp, tvec4, tvec4>(tvec4 < float, aligned_highp >
const & c,
