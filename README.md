...
> 由于 OpenCV 的库较大，需要使用 git lfs clone / git lfs pull 拉取
...
2. 弹出菜单
   ...
   - “face detect” 人脸检测及人脸特征点检测，点击按钮开启和关闭。
   - “opencv AR” 基于标签的 AR，点击按钮开启和关闭。
   - “yoloV5 detect” 物体检测，点击按钮开启和关闭。
...
### ProcessPipe
`ProcessPipe` 实时图像处理管道，支持多种检测算法。非常方便添加新的图像处理和检测功能。
