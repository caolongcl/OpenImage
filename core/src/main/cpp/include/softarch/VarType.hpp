...
/**************************************************************************************************/
  ...
  static const int ColorsSize = 19;
  static const Color Colors[] = {{0.21176471f, 0.2627451f,  0.95686275f,  1.0f},
                                 {0.3882353f,  0.11764706f, 0.9137255f,   1.0f},
                                 {0.6901961f,  0.15294118f, 0.6117647f,   1.0f},
                                 {0.7176471f,  0.22745098f, 0.40392157f,  1.0f},
                                 {0.70980394f, 0.31764707f, 0.24705882f,  1.0f},
                                 {0.9529412f,  0.5882353f,  0.12941177f,  1.0f},
                                 {0.95686275f, 0.6627451f,  0.011764706f, 1.0f},
                                 {0.83137256f, 0.7372549f,  0.0f,         1.0f},
                                 {0.53333336f, 0.5882353f,  0.0f,         1.0f},
                                 {0.3137255f,  0.6862745f,  0.29803923f,  1.0f},
                                 {0.2901961f,  0.7647059f,  0.54509807f,  1.0f},
                                 {0.22352941f, 0.8627451f,  0.8039216f,   1.0f},
                                 {0.23137255f, 0.92156863f, 1.0f,         1.0f},
                                 {0.02745098f, 0.75686276f, 1.0f,         1.0f},
                                 {0.0f,        0.59607846f, 1.0f,         1.0f},
                                 {0.13333334f, 0.34117648f, 1.0f,         1.0f},
                                 {0.28235295f, 0.33333334f, 0.4745098f,   1.0f},
                                 {0.61960787f, 0.61960787f, 0.61960787f,  1.0f},
                                 {0.54509807f, 0.49019608f, 0.3764706f,   1.0f}};
/**************************************************************************************************/
  /**
   * 用于传递参数，标识参数的类型
   */
