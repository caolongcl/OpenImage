...
template<typename T, precision P>
GLM_FUNC_QUALIFIER typename tmat4x2<T, P>::col_type &tmat4x2<T, P>::operator[](typename tmat4x2<T,
                                                                                                P>::length_type i) {
...
template<typename T, precision P>
GLM_FUNC_QUALIFIER typename tmat4x2<T, P>::col_type const &tmat4x2<T,
                                                                   P>::operator[](typename tmat4x2<T,
...
template<typename T, precision P>
GLM_FUNC_QUALIFIER typename tmat4x2<T, P>::row_type operator*(typename tmat4x2<T,
                                                                               P>::col_type const &v,
                                                              tmat4x2 <T, P> const &m) {
