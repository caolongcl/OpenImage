...
template<typename T, precision P,
  template<class, precision> class vecType, bool isFloat, bool Aligned>
struct compute_log2 {
...
struct compute_inversesqrt<vecType, float, lowp, Aligned> {
  GLM_FUNC_QUALIFIER static vecType<float, lowp> call(vecType<float, lowp> const &x) {
    ...
    vecType<uint, lowp>
      *p = reinterpret_cast<vecType<uint, lowp> *>(const_cast<vecType<float, lowp> *>(&x));
