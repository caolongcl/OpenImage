...
struct compute_vec4_div<float, aligned_lowp, true> {
  static tvec4<float, aligned_lowp> call(tvec4<float, aligned_lowp> const &a,
                                         tvec4<float, aligned_lowp> const &b) {
...
template<>
GLM_FUNC_QUALIFIER GLM_CONSTEXPR_SIMD tvec4<float, aligned_lowp>::tvec4(float a,
                                                                        float b,
                                                                        float c,
                                                                        float d) :
...
template<>
GLM_FUNC_QUALIFIER GLM_CONSTEXPR_SIMD tvec4<float, aligned_mediump>::tvec4(float a,
                                                                           float b,
                                                                           float c,
                                                                           float d) :
  data(_mm_set_ps(d, c, b, a)) {}
...
template<>
GLM_FUNC_QUALIFIER GLM_CONSTEXPR_SIMD tvec4<float, aligned_highp>::tvec4(float a,
                                                                         float b,
                                                                         float c,
                                                                         float d) :
  data(_mm_set_ps(d, c, b, a)) {}
...
template<>
template<>
GLM_FUNC_QUALIFIER GLM_CONSTEXPR_SIMD tvec4<int32, aligned_lowp>::tvec4(int32 a,
                                                                        int32 b,
                                                                        int32 c,
                                                                        int32 d) :
...
template<>
template<>
GLM_FUNC_QUALIFIER GLM_CONSTEXPR_SIMD tvec4<int32, aligned_mediump>::tvec4(int32 a,
                                                                           int32 b,
                                                                           int32 c,
                                                                           int32 d) :
  data(_mm_set_epi32(d, c, b, a)) {}
...
template<>
template<>
GLM_FUNC_QUALIFIER GLM_CONSTEXPR_SIMD tvec4<int32, aligned_highp>::tvec4(int32 a,
                                                                         int32 b,
                                                                         int32 c,
                                                                         int32 d) :
  data(_mm_set_epi32(d, c, b, a)) {}
...
template<>
template<>
GLM_FUNC_QUALIFIER GLM_CONSTEXPR_SIMD tvec4<float, aligned_lowp>::tvec4(int32 a,
                                                                        int32 b,
                                                                        int32 c,
                                                                        int32 d) :
...
template<>
template<>
GLM_FUNC_QUALIFIER GLM_CONSTEXPR_SIMD tvec4<float, aligned_mediump>::tvec4(int32 a,
                                                                           int32 b,
                                                                           int32 c,
                                                                           int32 d) :
  data(_mm_castsi128_ps(_mm_set_epi32(d, c, b, a))) {}
...
template<>
template<>
GLM_FUNC_QUALIFIER GLM_CONSTEXPR_SIMD tvec4<float, aligned_highp>::tvec4(int32 a,
                                                                         int32 b,
                                                                         int32 c,
                                                                         int32 d) :
  data(_mm_castsi128_ps(_mm_set_epi32(d, c, b, a))) {}
