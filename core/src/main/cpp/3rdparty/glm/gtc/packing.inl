...
struct compute_half<P, tvec3> {
  GLM_FUNC_QUALIFIER static tvec3<uint16, P> pack(tvec3<float, P> const &v) {
    tvec3<int16, P> const
      Unpack(detail::toFloat16(v.x), detail::toFloat16(v.y), detail::toFloat16(v.z));
...
struct compute_half<P, tvec4> {
  GLM_FUNC_QUALIFIER static tvec4<uint16, P> pack(tvec4<float, P> const &v) {
    tvec4<int16, P> const Unpack(detail::toFloat16(v.x),
  ...
  GLM_FUNC_QUALIFIER static tvec4<float, P> unpack(tvec4<uint16, P> const &v) {
    ...
    memcpy(&Unpack, &v, sizeof(Unpack));
    return tvec4<float, P>(detail::toFloat32(v.x),
...
template<typename uintType, typename floatType, precision P,
...
template<typename intType, typename floatType, precision P,
  template<typename, precision> class vecType>
...
GLM_FUNC_QUALIFIER vecType<floatType, P> unpackSnorm(vecType<intType, P> const &v) {
  ...
  return clamp(vecType<floatType, P>(v) * (static_cast<floatType>(1)
                 / static_cast<floatType>(std::numeric_limits<intType>::max())),
