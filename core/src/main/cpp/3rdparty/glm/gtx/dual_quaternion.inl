...
GLM_FUNC_QUALIFIER GLM_CONSTEXPR typename tdualquat<T, P>::length_type tdualquat<T,
                                                                                 P>::length() const {
  return 2;
}

template<typename T, precision P>
GLM_FUNC_QUALIFIER typename tdualquat<T, P>::part_type &tdualquat<T,
                                                                  P>::operator[](typename tdualquat<
  T,
  P>::length_type i) {
...
template<typename T, precision P>
GLM_FUNC_QUALIFIER typename tdualquat<T, P>::part_type const &tdualquat<T,
                                                                        P>::operator[](typename tdualquat<
  T,
...
template<typename T, precision P>
GLM_FUNC_QUALIFIER GLM_CONSTEXPR tdualquat<T, P>::tdualquat(tquat<T, P> const &q,
                                                            tvec3<T, P> const &p)
  : real(q), dual(
