...
namespace glm {
namespace detail {
template<typename T, typename floatType, precision P,
  template<typename, precision> class vecType, bool isInteger, bool signedType>
...
struct compute_compNormalize<T, floatType, P, vecType, true, true> {
  ...
  call(vecType<T, P> const & v)
  {
    ...
    return (vecType < floatType, P > (v) - Min) / (Max - Min) * static_cast<floatType>(2)
...
struct compute_compScale<T, floatType, P, vecType, true, true> {
  ...
  {
    floatType const
      Max = static_cast<floatType>(std::numeric_limits<T>::max()) + static_cast<floatType>(0.5);
...
struct compute_compScale<T, floatType, P, vecType, true, false> {
  ...
  {
    return vecType < T, P
      > (vecType < floatType, P > (v) * static_cast<floatType>(std::numeric_limits<T>::max()));
  }
};
...
return
detail::compute_compNormalize<T,
                              floatType,
                              P,
                              vecType,
